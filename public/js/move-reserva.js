// OPTIMIZED FOR CORE WEB VITALS - Defer execution until DOM ready
(function () {
  "use strict";

  // Early exit if document not ready
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initReservaToggle);
    return;
  }

  initReservaToggle();

  function initReservaToggle() {
  ...
  } // End of initReservaToggle function
})();
